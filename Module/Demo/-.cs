...
global using DrawPolate = View.Draw.Polate;
global using DrawPolateKind = View.Draw.PolateKind;
global using DrawPolateKindList = View.Draw.PolateKindList;
global using DrawPolateLinear = View.Draw.PolateLinear;
global using DrawPolateRadial = View.Draw.PolateRadial;
global using DrawPolateStop = View.Draw.PolateStop;
global using DrawPolateStopPoint = View.Draw.PolateStopPoint;
global using DrawPolateSpread = View.Draw.PolateSpread;
global using DrawPolateSpreadList = View.Draw.PolateSpreadList;
global using DrawComp = View.Draw.Comp;
global using DrawCompList = View.Draw.CompList;
global using DrawColor = View.Draw.Color;
global using DrawFont = View.Draw.Font;
global using DrawAlignList = View.Draw.AlignList;
...
global using MediaVideoOut = View.Media.VideoOut;
global using MediaAudioOut = View.Media.AudioOut;
